...
2. In pgAdmin，Run these query to create the Postgres landing zone for the first events and windows:
...
3. Send data(topic/messages) to Kafka
$ python src/producers/producer.py

4. Run the PyFlink job!  
...
(This is how to run insert into, select, start, with Flink)

5. groupby --src/job/aggregation.py
