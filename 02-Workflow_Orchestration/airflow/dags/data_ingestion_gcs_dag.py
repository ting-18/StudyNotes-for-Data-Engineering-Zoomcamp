...
# dataset_url from 2022 course(aws.s3) doesn't exist.
...
with DAG(
    ...
    #         },
    #     },
    # )   #This one can't read schema automatically
    ...
    load_parquet_to_bq = GCSToBigQueryOperator(
        ...
        destination_project_dataset_table=f'{PROJECT_ID}.{BIGQUERY_DATASET}.yellow_taxi_table',
        skip_leading_rows=1,
    ...
    download_dataset_task >> format_to_parquet_task >> local_to_gcs_task >> load_parquet_to_bq
